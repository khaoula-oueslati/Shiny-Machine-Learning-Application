...
#' @author khaoula oueslati-hibat allah thlithi, \email{khaoula.oueslati@outlook.fr}
#' @export
#' 
#' 
library(dygraphs)
...
shinyML_regression <- function(data = data,y,framework = "h2o", share_app = FALSE,port = NULL){
  ...
  argonNav  <- argonDashNavbar(
    argonDropNav(
      ...
      src = "https://www.zupimages.net/up/21/03/jnql.png", 
      orientation = "left"
    )
  )
  ...
  argonFooter <- argonDashFooter(
    copyrights = "@shinyMachineLearning, 2021",
    src = "https://github.com/khaoula-oueslati/Shiny-Machine-Learning-Application",
    argonFooterMenu(
      argonFooterItem("GitHub", src = "https://github.com/khaoula-oueslati/Shiny-Machine-Learning-Application")
    )
  )
  ...
  app <- shiny::shinyApp(
    ui = argonDashPage(
      useShinyjs(),  
      title = "shinyMLRegression",
      author = "Khaoula-hibat",
